...
class LineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line_item" do
    assert_difference('LineItem.count') do
      ...
      #post :create, product_id: products(:ruby).id # from pdf-file
    end

    #assert_redirected_to line_item_url(LineItem.last) # default
    #assert_redirected_to cart_path(@line_item.cart) # from PDF  -- test will fail :(
  end
